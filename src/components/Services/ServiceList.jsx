...
const services = [
  {
    id: 1,
    icon: <FaStethoscope className="text-blue-600" size={32} />,
  ...
  {
    id: 2,
    icon: <FaHeartbeat className="text-blue-600" size={32} />,
    title: "Cardiology",
    description:
  ...
  {
    id: 3,
    icon: <FaSyringe className="text-blue-600" size={32} />,
  ...
  {
    id: 4,
    icon: <FaUserMd className="text-blue-600" size={32} />,
  ...
  {
    id: 5,
    icon: <FaPills className="text-blue-600" size={32} />,
  ...
  {
    id: 6,
    icon: <FaXRay className="text-blue-600" size={32} />,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">
            What We <span className="text-blue-700 underline decoration-blue-300 decoration-4 underline-offset-4">Offer</span>
          </h2>
        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="bg-gray-50 hover:bg-gray-100 transition-colors duration-300 rounded-xl p-6 shadow-md text-center flex flex-col items-center h-full"
            >
