...
const ServiceDetailsTabs = () => {
  ...
  return (
    <section className="bg-gray-50 py-20 px-6 md:px-12 my-[-50px]">
          ...
          {tabs.map(({ id, label, icon: Icon }) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-full border transition-all duration-300 text-sm sm:text-base font-medium shadow-sm select-none
                  ${
                    isActive
