    ...
    >
      ...
      <div className="flex-1 max-w-xl text-center lg:text-left">
        <h2
          ...
          className="text-4xl sm:text-5xl font-extrabold text-blue-900 tracking-tight mb-4 leading-tight"
        >
        ...
        <button
          type="button"
          className="inline-block px-8 py-4 bg-blue-600 hover:bg-blue-700 focus-visible:ring-4 focus-visible:ring-blue-300 text-white font-semibold rounded-lg shadow-md transition-colors duration-300"
        >
