      ...
      >
        ...
        >
          {insurances.map(({ id, name, icon }) => (
            <motion.li
              key={id}
              className="flex flex-col items-center bg-white rounded-xl shadow-md p-8 cursor-default select-none focus-within:ring-4 focus-within:ring-blue-400 focus-within:outline-none transition-transform duration-300"
              variants={itemVariants}
