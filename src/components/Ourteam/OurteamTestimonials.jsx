    ...
    >
      ...
      {testimonials.map(({ id, name, role, photo, location, date, rating, text }, index) => (
        <motion.article
          ...
          viewport={{ once: true }}
          className="bg-white rounded-3xl shadow-lg p-8 md:p-10 flex flex-col md:flex-row gap-8 md:gap-12 hover:shadow-xl transition-shadow focus-within:shadow-xl outline-none"
          tabIndex={0}
        >
          {/* Photo */}
