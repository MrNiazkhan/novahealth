  ...
  return (
    <footer className="bg-gray-900 text-gray-300 select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
        {/* About Section */}
        <div>
          <h3 className="text-white text-base font-semibold mb-2 tracking-wide">NovaHealth</h3>
          <p className="text-gray-400 leading-snug text-[12px] sm:text-xs">
            NovaHealth is dedicated to providing the best healthcare solutions with a team of expert professionals and cutting-edge technology.
          </p>
        </div>

        {/* Quick Links with 2 columns grid on md+ */}
        <div>
          <h3 className="text-white text-base font-semibold mb-2 tracking-wide">Quick Links</h3>
  ...
  {[
    ...
    <li key={label}>
      <a
        ...
        tabIndex={0}
        onKeyDown={(e) => e.key === "Enter" && alert(`Navigate to ${label}`)}
      >
        {label}
      </a>
    </li>
        ...
        {/* Contact Info */}
        <div>
          <h3 className="text-white text-base font-semibold mb-2 tracking-wide">Contact Us</h3>
          <address className="not-italic space-y-1 text-gray-400 text-[12px] sm:text-xs leading-tight">
            ...
            <p>
              Phone:{" "}
              <a href="tel:+1234567890" className="hover:text-blue-500 transition-colors duration-200 whitespace-nowrap">
                +1 (234) 567-890
              </a>
            </p>
            <p>
              Email:{" "}
              <a href="mailto:info@novahealth.com" className="hover:text-blue-500 transition-colors duration-200 whitespace-nowrap">
                info@novahealth.com
              </a>
            </p>
        ...
        {/* Social Media with official icons */}
        <div>
          <h3 className="text-white text-base font-semibold mb-2 tracking-wide">Follow Us</h3>
          <div className="flex space-x-5 text-gray-400">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M22.675 0h-21.35C.595 0 0 .592 0 1.324v21.351C0 23.407.593 24 1.325 24h11.495v-9.294H9.691v-3.622h3.129V8.413c0-3.1 1.894-4.788 4.659-4.788 1.325 0 2.466.099 2.797.143v3.24l-1.918.001c-1.504 0-1.796.715-1.796 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.406 24 22.675V1.324C24 .592 23.406 0 22.675 0z" />
              </svg>
            </a>
